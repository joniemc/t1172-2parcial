...
{
    public class CuentaBancariaPremiun : CuentaBancariaBase
    {
        public CuentaBancariaPremiun(string idCuenta, string nombrePropietario, 
        ...
        public override double CalcularInteres()
        {
            ...
            if (base.Balance > 20000) {
                interesGanado = interesGanado+(interesGanado*0.15);
            }
